...
We get JSON schemas of dbt artifacts which we want to add or update from [schemas.getdbt.com](https://schemas.getdbt.com/) (the canonical host referenced in artifact `metadata.dbt_schema_version`).
