...
class Config9(BaseParserModel):
    ...
    latest_version_pointer: LatestVersionPointer | None = Field(
...
class Nodes4(BaseParserModel):
    ...
    version: int | float | str | None = None
    latest_version: int | float | str | None = None
...
class Config19(BaseParserModel):
    ...
    snowflake: Snowflake | None = Field(None, title="SnowflakeFunctionConfig")
...
class External(BaseParserModel):
    ...
    partitions: list[Partitions | str] | None = None
...
class Macros(BaseParserModel):
    ...
    created_at: float | None = None
    supported_languages: list[SupportedLanguages | SupportedLanguages1] | None = None
...
class Overload1(BaseParserModel):
    ...
    defined_in: str
    arguments: list[Argument4] | None = None
    returns: Returns | None = None
    description: str | None = None
    raw_body: str | None = None
    compiled_body: str | None = None
...
class Disabled8(BaseParserModel):
    ...
    arguments: list[Argument4] | None = None
    overloads: list[Overload1] | None = None
...
class Versions(BaseParserModel):
    ...
    include: list[int | float | str] | None = None
    exclude: list[int | float | str] | None = None
...
class Functions(BaseParserModel):
    ...
    arguments: list[Argument4] | None = None
    overloads: list[Overload2] | None = None
