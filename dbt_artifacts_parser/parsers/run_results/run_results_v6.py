...
class Metadata(BaseRunResultsParserModel):
...
class TimingItem(BaseRunResultsParserModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    name: str
...
class Result(BaseRunResultsParserModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class RunResultsV6(BaseRunResultsParserModel):
    model_config = ConfigDict(
        extra='forbid',
    )
