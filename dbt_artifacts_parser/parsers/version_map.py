...
ARTIFACT_INFO = {
    # V1
    "CATALOG_V1":
        ArtifactInfo("https://schemas.getdbt.com/dbt/catalog/v1.json",
                     ArtifactsTypes.CATALOG_V1, DestinationTables.CATALOG_V1,
                     CatalogV1),
    "MANIFEST_V1":
        ArtifactInfo("https://schemas.getdbt.com/dbt/manifest/v1.json",
                     ArtifactsTypes.MANIFEST_V1, DestinationTables.MANIFEST_V1,
                     ManifestV1),
    "RUN_RESULTS_V1":
        ArtifactInfo("https://schemas.getdbt.com/dbt/run-results/v1.json",
                     ArtifactsTypes.RUN_RESULTS_V1,
                     DestinationTables.RUN_RESULTS_V1, RunResultsV1),
    "SOURCES_V1":
        ArtifactInfo("https://schemas.getdbt.com/dbt/sources/v1.json",
                     ArtifactsTypes.SOURCES_V1, DestinationTables.SOURCES_V1,
                     SourcesV1),
    # V2
    "MANIFEST_V2":
        ArtifactInfo("https://schemas.getdbt.com/dbt/manifest/v2.json",
                     ArtifactsTypes.MANIFEST_V2, DestinationTables.MANIFEST_V2,
                     ManifestV2),
    "RUN_RESULTS_V2":
        ArtifactInfo("https://schemas.getdbt.com/dbt/run-results/v2.json",
                     ArtifactsTypes.RUN_RESULTS_V2,
                     DestinationTables.RUN_RESULTS_V2, RunResultsV2),
    "SOURCES_V2":
        ArtifactInfo("https://schemas.getdbt.com/dbt/sources/v2.json",
                     ArtifactsTypes.SOURCES_V2, DestinationTables.SOURCES_V2,
                     SourcesV2),
    # V3
    "MANIFEST_V3":
        ArtifactInfo("https://schemas.getdbt.com/dbt/manifest/v3.json",
                     ArtifactsTypes.MANIFEST_V3, DestinationTables.MANIFEST_V3,
                     ManifestV3),
    "RUN_RESULTS_V3":
        ArtifactInfo("https://schemas.getdbt.com/dbt/run-results/v3.json",
                     ArtifactsTypes.RUN_RESULTS_V3,
                     DestinationTables.RUN_RESULTS_V3, RunResultsV3),
    "SOURCES_V3":
        ArtifactInfo("https://schemas.getdbt.com/dbt/sources/v3.json",
                     ArtifactsTypes.SOURCES_V3, DestinationTables.SOURCES_V3,
                     SourcesV3),
    # V4
    "MANIFEST_V4":
        ArtifactInfo("https://schemas.getdbt.com/dbt/manifest/v4.json",
                     ArtifactsTypes.MANIFEST_V4, DestinationTables.MANIFEST_V4,
                     ManifestV4),
    "RUN_RESULTS_V4":
        ArtifactInfo("https://schemas.getdbt.com/dbt/run-results/v4.json",
                     ArtifactsTypes.RUN_RESULTS_V4,
                     DestinationTables.RUN_RESULTS_V4, RunResultsV4),
}
